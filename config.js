...
global.sudo = process.env.SUDO || '923075715150'
global.devs = '923075715150';
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Naveed Baloch' : process.env.BOT_NAME,
